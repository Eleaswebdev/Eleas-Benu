...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210811_benuestore_8ee42b2e42907dcc1233_20210811123548_archive.zip';
	const ARCHIVE_SIZE		 = '145029103';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8ee42b2-11123548';
    const SECONDARY_PACKAGE_HASH = 'f5c4ed6-11123548';
	const VERSION			 = '1.4.2';
