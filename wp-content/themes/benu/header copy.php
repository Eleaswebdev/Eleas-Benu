                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="megamenu_inner">
                                                                ...
                                                                <ul>
                                                                    <li><a href="#">Pen Holder</a></li>
                                                                    <li><a href="#">Phone Holder</a></li>
                                                                    <li><a href="#">Paper Weight</a></li>
                                                                    <li><a href="#">Desk Mini Planters</a></li>
                                                                    <li><a href="#">Shops</a></li>
                                                                    <li><a href="#">Colorverse</a></li>
                                                        ...
                                                        <div class="col">
                                                            <div class="megamenu_inner">
                                                                ...
                                                                <ul>
                                                                    <li><a href="#">Aztec Golds</a></li>
                                                                    <li><a href="#">Enchanted Forest</a></li>
                                                                    <li><a href="#">Mystery</a></li>
                                                                    <li><a href="#">Neutica</a></li>
                                                                    <li><a href="#">Silver Strom</a></li>
                                                        ...
                                                        <div class="col">
                                                            <div class="megamenu_inner">
                                                                <h2>Briolette</h2>
                                                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perferendis odit nemo, nulla quos recusandae earum.</p>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="megamenu_inner">
                                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/media/images/new_arrival/2.jpg" alt="" class="img-fluid">
                                                                <button class="btn_transparent width_full mt_20">
                                                                    SHOP NOW
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="megamenu_inner">
                                                                <h2>PAPERWEIGHTS</h2>
                                                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perferendis odit nemo, nulla quos
                                                                    recusandae earum.</p>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                            ...
                                            <div class="megamenu">
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-5">
                                                            <div class="megamenu_inner">
                                                                <h2>Desk Accessories Gift Set </h2>
                                                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perferendis odit nemo, nulla quos
                                                                    recusandae earum.</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-3">
                                                            <div class="megamenu_inner">
                                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/media/images/new_arrival/3.jpg" alt="" class="img-fluid">
                                                                <button class="btn_transparent width_full mt_20">
                                                                    SHOP NOW
                                                                </button>
                                                            </div>
                                            ...
                                            <div class="megamenu">
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="megamenu_inner">
                                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/media/images/new_arrival/5.jpg" alt="" class="img-fluid">
                                                                <button class="btn_transparent width_full mt_20">
                                                                    SHOP NOW
                                                                </button>
                                                            </div>
        ...
        <div class="mobile_menu">
            ...
            <div class="menu-list clearfix">
                <ul id="menu-content" class="menu-content">
                    <li data-toggle="collapse" data-target="#Brand" class="collapsed">
                        Writing Instruments
                    </li>
                    <div class="sub-menu collapse" id="Brand">
                        <h3>SHOP BY PRODUCT</h3>
                        <ul>
                            <li><a href="#">Pen Holder</a></li>
                            <li><a href="#">Phone Holder</a></li>
                    ...
                    <div class="sub-menu collapse" id="ACCESSORIES">
                        <h3>SHOP BY PRODUCT</h3>
                        <ul>
                            <li><a href="#">Pen Holder</a></li>
                            <li><a href="#">Phone Holder</a></li>
                    ...
                    <li data-toggle="collapse" data-target="#Gifts" class="collapsed">
                        Gifts
                    </li>
                    <div class="sub-menu collapse" id="Gifts">
                        <h3>SHOP BY PRODUCT</h3>
                        <ul>
                            <li><a href="#">Pen Holder</a></li>
                            <li><a href="#">Phone Holder</a></li>
                    ...
                    <li data-toggle="collapse" data-target="#Collections" class="collapsed">
                        Shop by Collections
                    </li>
                    <div class="sub-menu collapse" id="Collections">
                        <h3>SHOP BY PRODUCT</h3>
                        <ul>
                            <li><a href="#">David Oscarson</a></li>
                            <li><a href="#">De Atramentis</a></li>
                            <li><a href="#">Diamine</a></li>
                            <li><a href="#">Diplomat</a></li>
                            <li><a href="#">Endless Works</a></li>
                            <li><a href="#">Colorverse</a></li>
                            <li><a href="#">Exacompta</a></li>
                            <li><a href="#">Aston Leather</a></li>
